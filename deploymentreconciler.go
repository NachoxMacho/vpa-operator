...
type VpaDeploymentReconciler struct {
	Client    client.Client
	Scheme    *runtime.Scheme
	VpaClient *versioned.Clientset
}

func (v *VpaDeploymentReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	err := v.Client.Get(ctx, req.NamespacedName, deployment)
