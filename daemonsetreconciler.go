...
type VpaDaemonSetReconciler struct {
	Client    client.Client
	Scheme    *runtime.Scheme
	VpaClient *versioned.Clientset
}

func (v *VpaDaemonSetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	err := v.Client.Get(ctx, req.NamespacedName, daemonset)
